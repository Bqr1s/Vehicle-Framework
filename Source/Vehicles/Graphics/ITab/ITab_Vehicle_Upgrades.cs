...
public class ITab_Vehicle_Upgrades : ITab
{
  ...
  public override void OnOpen()
  {
    ...
    bufferBefore = new RenderTextureBuffer(
      VehicleGui.GetTexture(VehicleGui.ImageSize.Large),
      VehicleGui.GetTexture(VehicleGui.ImageSize.Large)
    );
    bufferAfter = new RenderTextureBuffer(
      VehicleGui.GetTexture(VehicleGui.ImageSize.Large),
      VehicleGui.GetTexture(VehicleGui.ImageSize.Large)
    );
  }
