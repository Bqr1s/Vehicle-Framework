...
namespace Vehicles
{
  ...
  public static class VehicleTex
  {
    ...
    public static readonly Texture2D UnloadPassenger =
      ContentFinder<Texture2D>.Get("UI/Gizmos/UnloadPawn");
    ...
    public static readonly Texture2D[] PackCargoIcon = new Texture2D[]
    {
    ...
    public static readonly Texture2D[] CancelPackCargoIcon = new Texture2D[]
    {
    ...
    /// </summary>
    public static readonly Texture2D FormCaravanBoat =
      ContentFinder<Texture2D>.Get("UI/Gizmos/FormCaravanBoat");

    /// <summary>
    /// Unused - Use it if you want
    /// </summary>
    public static readonly Texture2D FormCaravanAerial =
      ContentFinder<Texture2D>.Get("UI/Gizmos/FormCaravanAerial");
    ...
    public static readonly Texture2D WarningIcon =
      ContentFinder<Texture2D>.Get("UI/Icons/WarningIcon");
    ...
    public static readonly Texture2D ConfigureFuelGauge =
      ContentFinder<Texture2D>.Get("UI/Gizmos/SetRefuelLevel");
    ...
    public static readonly Texture2D DismissTex =
      ContentFinder<Texture2D>.Get("UI/Commands/DismissShuttle");
    ...
    public static readonly Texture2D
      ResetAll = ContentFinder<Texture2D>.Get("UI/Settings/ResetAll");

    public static readonly Texture2D
      Settings = ContentFinder<Texture2D>.Get("UI/Settings/Settings");

    public static readonly Texture2D ExportSettings =
      ContentFinder<Texture2D>.Get("UI/Settings/ExportSettings");
    ...
    public static readonly Texture2D
      AltitudeMeter = null; // ContentFinder<Texture2D>.Get("UI/Gizmos/AltitudeMeter");
    ...
    public static readonly Texture2D RightArrow =
      ContentFinder<Texture2D>.Get("UI/Icons/ArrowRight");

    public static readonly Material LandingTargeterMat =
      MaterialPool.MatFrom("UI/Icons/LandingTargeter", ShaderDatabase.Transparent);
    ...
    public static readonly Dictionary<VehicleDef, Texture2D> CachedTextureIcons =
      new Dictionary<VehicleDef, Texture2D>();

    public static readonly Dictionary<VehicleDef, string> CachedTextureIconPaths =
      new Dictionary<VehicleDef, string>();

    public static readonly Dictionary<(VehicleDef, Rot4), Texture2D> CachedVehicleTextures =
      new Dictionary<(VehicleDef, Rot4), Texture2D>();

    public static readonly Dictionary<VehicleDef, Graphic_Vehicle> CachedGraphics =
      new Dictionary<VehicleDef, Graphic_Vehicle>();
