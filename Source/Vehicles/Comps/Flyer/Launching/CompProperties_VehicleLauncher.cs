...
{
  [PostToSettings(Label = "VF_FuelConsumptionWorld", Translate = true,
    Tooltip = "VF_FuelConsumptionWorldTooltip", UISettingsType = UISettingsType.FloatBox,
  ...
  [PostToSettings(Label = "VF_LaunchFixedMaxDistance", Translate = true,
    Tooltip = "VF_LaunchFixedMaxDistanceTooltip", UISettingsType = UISettingsType.SliderInt,
    VehicleType = VehicleType.Air)]
  [SliderValues(MinValue = 0, MaxValue = 100,
    MinValueDisplay = "VF_LaunchFixedMaxDistanceDisabled")]
  public int fixedLaunchDistanceMax = 0;

  [PostToSettings(Label = "VF_ControlInFlight", Translate = true,
    Tooltip = "VF_ControlInFlightTooltip", UISettingsType = UISettingsType.Checkbox,
    VehicleType = VehicleType.Air)]
  public bool controlInFlight = true;

  [PostToSettings(Label = "VF_CanRoofPunch", Tooltip = "VF_CanRoofPunchTooltip", Translate = true,
  ...
  [PostToSettings(Label = "VF_SpaceFlight", Translate = true, Tooltip = "VF_SpaceFlightTooltip",
