  ...
  public class CompUpgradeTree : VehicleComp, IRefundable
  {
    ...
    public override void PostDraw()
    {
      ...
      if (Upgrading)
      {
        ...
        int tiles =
          Mathf.CeilToInt(PercentComplete * Vehicle.RotatedSize.x * Vehicle.RotatedSize.z *
            4); //4 tiles per cell
    ...
    public override string CompInspectStringExtra()
    {
      if (upgrade != null)
      {
        ...
        return
          $"{"WorkLeft".Translate()}: {Vehicle.CompUpgradeTree.upgrade.WorkLeft.ToStringWorkAmount()}";
      }
      return null;
    }
