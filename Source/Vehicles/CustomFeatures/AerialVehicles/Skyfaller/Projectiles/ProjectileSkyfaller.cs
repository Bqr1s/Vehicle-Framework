...
namespace Vehicles
{
  ...
  public class ProjectileSkyfaller : Thing
  {
    ...
    {
      Graphics.DrawMesh(MeshPool.GridPlane(projectileDef.graphicData.drawSize), drawLoc,
        ExactRotation, projectileDef.DrawMatSingle, 0);
    }
    ...
    public virtual Vector3 ExactPosition
    {
      get
      {
        Vector3 b = (destination - origin) *
          Mathf.Clamp01(1f - ticksToImpact / ProjectileTicksToImpact);
    ...
    protected virtual void Impact()
    {
      if (Position.InBounds(Map))
      {
        ...
        quickProj.Launch(caster, destination.ToIntVec3().ToVector3Shifted(),
          destination.ToIntVec3(), destination.ToIntVec3(), quickProj.HitFlags, false, caster);
      }
      Destroy();
    }
