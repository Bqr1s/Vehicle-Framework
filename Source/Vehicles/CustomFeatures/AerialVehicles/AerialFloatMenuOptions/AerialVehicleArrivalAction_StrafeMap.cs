    ...
    public override void Arrived(AerialVehicleInFlight aerialVehicle, int tile)
    {
      LongEventHandler.QueueLongEvent(delegate()
      {
        ...
        StrafeTargeter.Instance.BeginTargeting(vehicle, vehicle.CompVehicleLauncher.launchProtocol,
          delegate(IntVec3 start, IntVec3 end)
          {
            VehicleSkyfaller_FlyOver skyfaller =
              VehicleSkyfallerMaker.MakeSkyfallerFlyOver(
    ...
    public static FloatMenuAcceptanceReport CanAttack(VehiclePawn vehicle, MapParent parent)
    {
      ...
      if (parent.EnterCooldownBlocksEntering())
      {
        return FloatMenuAcceptanceReport.WithFailReasonAndMessage(
          ...
          "MessageEnterCooldownBlocksEntering".Translate(parent.EnterCooldownTicksLeft()
           .ToStringTicksToPeriod(true, false, true, true)));
      }
      return true;
    }
  }
