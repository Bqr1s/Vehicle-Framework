...
namespace Vehicles
{
  public class PropellerTakeoff : VTOLTakeoff
  {
    ...
    public PropellerTakeoff(PropellerTakeoff reference, VehiclePawn vehicle) : base(reference,
      vehicle)
    {
    }

    public PropellerProtocolProperties LandingProperties_Propeller =>
      landingProperties as PropellerProtocolProperties;

    public PropellerProtocolProperties LaunchProperties_Propeller =>
      launchProperties as PropellerProtocolProperties;

    public PropellerProtocolProperties CurAnimationProperties_Propeller =>
      CurAnimationProperties as PropellerProtocolProperties;

    protected override int TotalTicks_Landing =>
      base.TotalTicks_Landing + LandingProperties_Propeller.maxTicksPropeller;

    protected override int TotalTicks_Takeoff =>
      base.TotalTicks_Takeoff + LaunchProperties_Propeller.maxTicksPropeller;
    ...
    protected override void TickMotes()
    {
      ...
      if (fleckData != null && (fleckData.runOutOfStep ||
        (TimeInAnimationPropeller > 0 && TimeInAnimationPropeller < 1)))
      {
        effectsToThrowPropeller =
          TryThrowFleck(fleckData, TimeInAnimationPropeller, effectsToThrowPropeller);
      }
      base.TickMotes();
    }
    ...
    protected override void TickEvents()
    {
      ...
      if (!CurAnimationProperties_Propeller.eventsPropeller.NullOrEmpty())
      {
        ...
        {
          AnimationEvent<LaunchProtocol> @event =
            CurAnimationProperties_Propeller.eventsPropeller[i];
    ...
    protected override (Vector3 drawPos, float rotation, DynamicShadowData shadowData)
      AnimateLanding(Vector3 drawPos, float rotation, DynamicShadowData shadowData)
    {
      ...
      {
        rotation +=
          LandingProperties_Propeller.rotationPropellerCurve.Evaluate(TimeInAnimationPropeller);
      }
      if (!LandingProperties_Propeller.zPositionPropellerCurve.NullOrEmpty())
      {
        drawPos.z +=
          LandingProperties_Propeller.zPositionPropellerCurve.Evaluate(TimeInAnimationPropeller);
      }
      if (!LandingProperties_Propeller.xPositionPropellerCurve.NullOrEmpty())
      {
        drawPos.x +=
          LandingProperties_Propeller.xPositionPropellerCurve.Evaluate(TimeInAnimationPropeller);
      }
      if (!LandingProperties_Propeller.offsetPropellerCurve.NullOrEmpty())
      {
        Vector2 offset =
          LandingProperties_Propeller.offsetPropellerCurve.EvaluateT(TimeInAnimationPropeller);
      ...
      if (LandingProperties_Propeller.renderShadow)
      {
        ...
        {
          shadowData.width =
            LandingProperties_Propeller.shadowSizeXPropellerCurve
             .Evaluate(TimeInAnimationPropeller);
        }
        if (!LandingProperties_Propeller.shadowSizeZPropellerCurve.NullOrEmpty())
        {
          shadowData.height =
            LandingProperties_Propeller.shadowSizeZPropellerCurve
             .Evaluate(TimeInAnimationPropeller);
        }
        if (!LandingProperties_Propeller.shadowAlphaPropellerCurve.NullOrEmpty())
        {
          shadowData.alpha =
            LandingProperties_Propeller.shadowAlphaPropellerCurve
             .Evaluate(TimeInAnimationPropeller);
        }
      }
      ...
      AnimateTakeoff(Vector3 drawPos, float rotation, DynamicShadowData shadowData)
    {
      ...
      {
        rotation +=
          LaunchProperties_Propeller.rotationPropellerCurve.Evaluate(TimeInAnimationPropeller);
      }
      if (!LaunchProperties_Propeller.zPositionPropellerCurve.NullOrEmpty())
      {
        drawPos.z +=
          LaunchProperties_Propeller.zPositionPropellerCurve.Evaluate(TimeInAnimationPropeller);
      }
      if (!LaunchProperties_Propeller.xPositionPropellerCurve.NullOrEmpty())
      {
        drawPos.x +=
          LaunchProperties_Propeller.xPositionPropellerCurve.Evaluate(TimeInAnimationPropeller);
      }
      if (!LaunchProperties_Propeller.offsetPropellerCurve.NullOrEmpty())
      {
        Vector2 offset =
          LaunchProperties_Propeller.offsetPropellerCurve.EvaluateT(TimeInAnimationPropeller);
        drawPos += new Vector3(offset.x, 0, offset.y);
      }
      ...
      if (LaunchProperties_Propeller.renderShadow)
      {
        ...
        {
          shadowData.width =
            LaunchProperties_Propeller.shadowSizeXPropellerCurve.Evaluate(TimeInAnimationPropeller);
        }
        if (!LaunchProperties_Propeller.shadowSizeZPropellerCurve.NullOrEmpty())
        {
          shadowData.height =
            LaunchProperties_Propeller.shadowSizeZPropellerCurve.Evaluate(TimeInAnimationPropeller);
        }
        if (!LaunchProperties_Propeller.shadowAlphaPropellerCurve.NullOrEmpty())
        {
          shadowData.alpha =
            LaunchProperties_Propeller.shadowAlphaPropellerCurve.Evaluate(TimeInAnimationPropeller);
        }
      }
    ...
    {
      return ticksPassedPropeller >= CurAnimationProperties_Propeller.maxTicksPropeller &&
        base.FinishedAnimation(skyfaller);
    }
    ...
    {
      base.ExposeData();
      Scribe_Values.Look(ref ticksPassedPropeller, nameof(ticksPassedPropeller));
      Scribe_Values.Look(ref effectsToThrowPropeller, nameof(effectsToThrowPropeller));
    }
  }
}