...
public class UpgradeNode
{
  ...
  public List<string>
    disableIfUpgradeNodesEnabled; //TODO - Remove in 1.6 in favor of disable conditions
  ...
  {
    return vehicle.CompUpgradeTree.upgradeContainer.InnerListForReading.Where(t => t.def == def)
     .Count();
  }
