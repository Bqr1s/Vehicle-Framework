...
namespace Vehicles
{
  public static class ProjectileHelper
  {
    ...
    public static bool DeflectProjectile(Projectile projectile, VehiclePawn deflectedOff)
    {
      ...
      float angle = (projectile.ExactRotation.eulerAngles.y + Rand.Range(-10, 10)).ClampAngle();
      ...
      deflectedProjectile.Deflect(projectile, deflectedOff, distanceRange.RandomInRange, angle,
        Mathf.Sqrt(distance));
