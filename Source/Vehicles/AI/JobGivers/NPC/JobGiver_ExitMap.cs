  ...
  public abstract class JobGiver_ExitMap : ThinkNode_JobGiver
  {
    ...
    protected override Job TryGiveJob(Pawn pawn)
    {
      ...
      bool activeThreat = vehicle.Faction != null &&
        GenHostility.AnyHostileActiveThreatTo(vehicle.Map, vehicle.Faction);
      ...
      if (vehicle.VehicleDef.npcProperties != null &&
        vehicle.VehicleDef.npcProperties.reverseWhileFleeing)
      {
      ...
      job.locomotionUrgency =
        PawnUtility.ResolveLocomotion(vehicle, defaultLocomotion, LocomotionUrgency.Jog);
