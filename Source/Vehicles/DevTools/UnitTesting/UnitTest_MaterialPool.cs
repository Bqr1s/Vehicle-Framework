  ...
  private void LifetimeManagement()
  {
    foreach (VehiclePawn vehicle in vehicles)
    {
      ...
      if (vehicle.CompVehicleTurrets != null && !vehicle.CompVehicleTurrets.turrets.NullOrEmpty())
      {
        ...
        Expect.IsEqual(vehicleMats.CacheTargets, targets, "Add Turret CacheTarget");
        Expect.IsEqual(vehicleMats.MaterialsAllocated, materialCount, "Materials Allocated");
      }
      ...
      Expect.IsEqual(vehicleMats.CacheTargets, targets, "Add CacheTarget");
      Expect.IsEqual(vehicleMats.MaterialsAllocated, materialCount, "Materials Allocated");
      ...
      if (vehicle.overlayRenderer.Overlays.Count > 0)
      {
        ...
        Expect.IsEqual(overlayMats.CacheTargets, overlayTargets, "Add Overlay CacheTarget");
        Expect.IsEqual(overlayMats.MaterialsAllocated, overlayMaterialCount,
          "Materials Allocated");
      }
