...
namespace Vehicles
{
  ...
  public class VehicleHandler : IExposable, ILoadReferenceable, IThingHolderPawnOverlayer
  {
    ...
    {
      handlers = new ThingOwner<Pawn>(this, false);
    }
    ...
    {
      get { return role != null && handlers.Count < role.Slots; }
    }
    ...
    public void ExposeData()
    {
      ...
      if (Scribe.mode == LoadSaveMode.Saving)
      {
        ...
        handlers.contentsLookMode =
          (handlers.InnerListForReading.FirstOrDefault()?.IsWorldPawn() ?? false) ?
            LookMode.Reference :
            LookMode.Deep;
      }
